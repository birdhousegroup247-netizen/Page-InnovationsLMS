...
class AttendanceController {
   ...
   * Older codes for this session are NOT explicitly deleted — the
   * "active code" lookup uses created_at DESC + expires_at filter,
   * so they age out naturally.
   */
  ...
  static async checkIn(req, res, next) {
    try {
      ...
      if (!codeRow) throw new BadRequestError('Code is invalid or has expired');
