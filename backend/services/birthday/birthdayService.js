 ...
 * Birthday Service
 *
 * - Daily cron at 06:05 UTC fires a "Happy Birthday from TekyPro"
...
async function runDailyBirthdayJob() {
  ...
  for (const u of users) {
    ...
    try {
      // Personalized birthday note, written like a human at TekyPro
      ...
      const message =
        ...
        `Everyone at TekyPro is rooting for you today. ` +
