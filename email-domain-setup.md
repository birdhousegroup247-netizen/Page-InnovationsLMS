...
- [ ] Verify pageinnovation.com domain (steps above) → then `EMAIL_FROM=Page Innovations <noreply@pageinnovation.com>`
- [ ] Optional per-purpose senders (already supported in code):
      ...
      `EMAIL_FROM_PORTAL=Page Innovations <sportal@pageinnovation.com>`
...
- [ ] Discord **client secret** (developer portal → OAuth2)
      — Guild ID already recovered from the invite link: `928124593795915796` (server "Page Innovations-DBA")
...
- [ ] Invite the bot to the Page Innovations-DBA server with role-manage permissions
