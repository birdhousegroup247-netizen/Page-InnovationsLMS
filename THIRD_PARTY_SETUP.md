...
This guide will help you configure the three external services required for TekyPro LMS:
...
5. Select:
   - App: "Mail"
   - Device: "Other (Custom name)" → Type "TekyPro LMS"
   `xsbx qmuy tlrr afmo`
...
**TekyPro LMS** - The Leading Remote DBA Training Platform
