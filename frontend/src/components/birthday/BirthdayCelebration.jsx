        ...
        <p className="text-gray-600 dark:text-text-dark-secondary mb-6 leading-relaxed">
          {isBelated ? (
            <>
              ...
              — but we didn't want to skip it. Everyone at Page Innovations is wishing you a brilliant year
              ahead. Thanks for being part of this community. 🎂
            </>
          ) : (
            <>
              The whole Page Innovations team is celebrating with you today.
