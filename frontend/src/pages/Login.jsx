...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-dark-900 transition-colors">
      {/* Back to role selection — mirrors the theme toggle (top-left). The
          icon is always visible; the label tucks away on small screens so
          it doesn't crowd the top of the form on mobile. */}
      <Link
        to="/"
