    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
          Updates from Page Innovations and your instructors.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="p-10 text-center bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-xl">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-xs mt-1">
            When Page Innovations or your instructors post updates, they'll show up here.
          </p>
        </div>
      ) : visible.length === 0 ? (
        <div className="p-10 text-center bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-xl">
        ...
        <div className="flex flex-col gap-4">
          {visible.map((a) => {
            ...
            const sourceLabel = isAdminSrc ? 'Page Innovations' : 'Instructor';
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3 pt-3 border-t border-gray-100 dark:border-dark-700">
                  <div className="flex items-center gap-2 min-w-0 flex-1 text-[11px] text-gray-500 dark:text-gray-400">
                    ...
                    <span className="truncate">{a.author_name || (isAdminSrc ? 'Page Innovations' : 'Instructor')}</span>
                    {a.course?.title && (
