      ...
      <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-lg border border-gray-100 dark:border-dark-700 p-8 max-w-lg w-full text-center">
        {notFound ? (
          ...
          <>
            ...
            <p className="text-gray-500 dark:text-text-secondary text-sm mb-6">This certificate is authentic and was issued by Page Innovations</p>
