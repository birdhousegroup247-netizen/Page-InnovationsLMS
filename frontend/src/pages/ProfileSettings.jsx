            ...
            {isSettingsView && activeTab === 'privacy' && (
              <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-border-dark p-6 space-y-5">
                ...
                {[
                  ...
                  { key: 'allow_birthday_wishes', label: 'Allow birthday wishes from classmates', desc: 'When off, only the system note from Page Innovations is sent on your birthday.' },
                ].map((row) => (
                ...
                <div className="pt-3 border-t border-gray-100 dark:border-border-dark">
                  ...
                  >
                    ...
                    <option value="members">Members only — only signed-in Page Innovations users</option>
                        ...
                        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                          ...
                          <div>
                            ...
                            <p className="text-green-700 dark:text-green-400 text-xs mt-0.5">
                              {discordStatus.in_server ? 'You are in the Page Innovations Discord server' : 'Account linked — join any course to get a channel invite'}
                            </p>
                          </div>
                        </div>
